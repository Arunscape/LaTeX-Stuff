...
To obtain our graph, Equation 1 was linearized to obtain:
$$\ln(|F_m|)=-n\ln(z)+ln(C)$$
For both materials, C had to be positive, or it would have been impossible to
obtain the natural logarithm $\ln(C)$.
Therefore, in Equation 3, $\chi$ must be positive, in order for C to be positive.
This is further reinforced by the fact that the magnetic force is attractive when the
strong magnet gets close to the nickel, which is a soft ferromagnetic material and therefore has the inverse $7^{th}$ power
