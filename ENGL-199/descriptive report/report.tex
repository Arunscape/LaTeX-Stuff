...
\begin{document}
  ...
  \$50 000 might seem expensive to some for a car, but I would argue that it is worth
  it for all of the features you get that are not offered in other cars priced similarly.
  ...
  Using electricity to power a Tesla vehicle is far more efficient than powering a car
  with gasoline.
  %Long term savings
  % \cite{money}
